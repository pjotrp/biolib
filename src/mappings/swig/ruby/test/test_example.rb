...
genotypes = [1,2,
             3,4,
             5,6]
phenotypes = [1.0,2.0,3.0,4.0]
weights = [1.0,1.0,1.0,1.0]
result = Biolib::Example.scanone_mr(2,3,6,genotypes,[],0,[1.0],1,phenotypes,weights)
raise "Test failed with value #{result}" if result != [ 6.0, 1.0, 2.0 ]
