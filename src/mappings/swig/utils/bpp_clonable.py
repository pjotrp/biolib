...
class Clonable(_object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _bpp_clonable.delete_Clonable
    __del__ = lambda self : None;
    def clone(*args): return _bpp_clonable.Clonable_clone(*args)
Clonable_swigregister = _bpp_clonable.Clonable_swigregister
