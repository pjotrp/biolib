...
class Clonable(_object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _bpp_string.delete_Clonable
    __del__ = lambda self : None;
    def clone(*args): return _bpp_string.Clonable_clone(*args)
Clonable_swigregister = _bpp_string.Clonable_swigregister
Clonable_swigregister(Clonable)

class String(Clonable):
    __swig_setmethods__ = {}
    ...
    def __init__(self, *args): 
        this = _bpp_string.new_String(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _bpp_string.delete_String
    __del__ = lambda self : None;
    def clone(*args): return _bpp_string.String_clone(*args)
String_swigregister = _bpp_string.String_swigregister
